pipeline {
  ...
  parameters {
    ...
    choice       name: 'DNS_DOMAIN_NAME', choices: ['aks.thehypepipe.co.uk', 'bakers-foundry.co.uk'], description: 'Selecting between Adam\'s and Steve\'s Domain Names for collaborative builds.'
